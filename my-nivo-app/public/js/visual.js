...
*/
  ...
  const config = {
    ...
    */
    ...
    use_img: true,
    imgs: {
      item: "http://i1.hdslb.com/bfs/face/983034448f81f45f05956d0455a86fe0639d6a36.jpg",
      name: "http://i1.hdslb.com/bfs/face/983034448f81f45f05956d0455a86fe0639d6a36.jpg",
      img: "path/to/img",
    },
    ...
    function redraw() {
      ...
      if (!long) {
        barEnter
          ...
          .tween("text", function (d) {
            // Apply tween animation for smooth transition
            var self = this;
